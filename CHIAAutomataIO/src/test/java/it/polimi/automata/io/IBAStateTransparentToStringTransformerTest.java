...
public class IBAStateTransparentToStringTransformerTest {
	...
	/**
	 * Test method for
	 * {@link it.polimi.automata.io.IBAStateTransparentToStringTransformer#IBAStateTransparentToStringTransformer(null)}
	 * .
	 */
	...
	/**
	 * Test method for
	 * {@link it.polimi.automata.io.IBAStateTransparentToStringTransformer#IBAStateTransparentToStringTransformer(it.polimi.automata.IBA)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link it.polimi.automata.io.IBAStateTransparentToStringTransformer#transform(null)}
	 * .
	 */
	@Test(expected = NullPointerException.class)
	...
	/**
	 * Test method for
	 * {@link it.polimi.automata.io.IBAStateTransparentToStringTransformer#transform(it.polimi.automata.state.State)}
	 * .
	 */
	@Test
