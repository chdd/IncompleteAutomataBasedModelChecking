...
INTERSECTIONT extends ConstrainedTransition<STATE>,
LAYOUT extends AbstractLayout<INTERSECTIONS, INTERSECTIONT>>
extends SaveAction<STATE, STATEFACTORY, TRANSITION, TRANSITIONFACTORY, LAYOUT> {
...
/*	@Override
	...
	@Override
	public <INTERSECTIONSTATE extends IntersectionState<STATE>, INTERSECTIONSTATEFACTORY extends IntersectionStateFactory<STATE, INTERSECTIONSTATE>, INTERSECTIONTRANSITION extends ConstrainedTransition<STATE>, INTERSECTIONTRANSITIONFACTORY extends ConstrainedTransitionFactory<STATE, INTERSECTIONTRANSITION>> 
	void perform(
		...
		String filePath=this.getFile();
		if(filePath!=null){
			model.saveIntersection(filePath, (AbstractLayout<INTERSECTIONSTATE, INTERSECTIONTRANSITION>) this.layout);
		}
