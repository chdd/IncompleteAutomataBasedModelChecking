...
extends SaveAction<CONSTRAINEDELEMENT, STATE,  TRANSITION, LAYOUT> {
	...
	void perform(
		...
		IIntBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION>> intBaWriter;
		...
		if(filePath!=null){
			intBaWriter=new IntBAWriter<CONSTRAINEDELEMENT,
					...
					INTERSECTIONSTATE, 
					INTERSECTIONTRANSITION,
					IIntBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION>>((AbstractLayout<INTERSECTIONSTATE, INTERSECTIONTRANSITION>)  this.layout);
