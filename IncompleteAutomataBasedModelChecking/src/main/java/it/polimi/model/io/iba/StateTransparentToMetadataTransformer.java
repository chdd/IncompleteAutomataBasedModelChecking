...
public class StateTransparentToMetadataTransformer <S extends State, T extends LabelledTransition,BA extends IncompleteBuchiAutomaton<S, T>> implements Transformer<S, String> {
