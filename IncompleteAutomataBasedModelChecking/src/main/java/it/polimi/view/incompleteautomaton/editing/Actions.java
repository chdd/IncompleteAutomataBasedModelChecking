...
public class Actions {
	...
	public static class AddCharacter extends Box implements EdgeMenuListener<State,LabelledTransition> {
        ...
        public AddCharacter() {
        	...
        	this.add(new JLabel("Character: "));
        	this.character=new JTextField("New character");
        	this.add(character);
         ...
         * @param visComp 
         */
        public void setEdgeAndView(LabelledTransition edge, VisualizationViewer<State,LabelledTransition> visComp) {
            this.edge = edge;
    ...
    @SuppressWarnings("serial")
	public static class DeleteEdgeMenuItem extends JMenuItem implements EdgeMenuListener<State,LabelledTransition> {
        private LabelledTransition edge;
        private VisualizationViewer<State,LabelledTransition> visComp;
    ...
    @SuppressWarnings("serial")
	public static class Rename extends Box implements StateMenuListener<State,LabelledTransition> {
        State v;
        ...
        public Initial(ActionListener l) {
            ...
            this.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                     ...
                     ((BuchiAutomaton<State,LabelledTransition>) visComp.getGraphLayout().getGraph()).addInitialState(v);;
                     visComp.repaint();
	...
	public static class Transparent extends JCheckBoxMenuItem implements StateMenuListener<State,LabelledTransition> {
        ...
        public Transparent() {
            ...
            this.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                	 visComp.getPickedVertexState().pick(v, false);
                     ((IncompleteBuchiAutomaton<State,LabelledTransition>) visComp.getGraphLayout().getGraph()).addTransparentState(v);;
                     visComp.repaint();
        ...
        public Accepting(ActionListener l) {
            ...
            this.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                	 visComp.getPickedVertexState().pick(v, false);
                     ((BuchiAutomaton<State,LabelledTransition>) visComp.getGraphLayout().getGraph()).addAcceptState(v);;
                     visComp.repaint();
                     listener.actionPerformed(e);
                }
        ...
        @SuppressWarnings("serial")
        public static class DeleteVertexMenuItem extends JMenuItem implements StateMenuListener<State, LabelledTransition> {
