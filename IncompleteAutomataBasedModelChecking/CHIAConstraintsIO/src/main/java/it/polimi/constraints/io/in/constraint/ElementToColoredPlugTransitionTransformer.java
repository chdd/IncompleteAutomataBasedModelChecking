...
public class ElementToColoredPlugTransitionTransformer {
	 ...
	 */
	public ColoredPluggingTransition transform(Element e) {
		...
		ColoredPluggingTransition.ID_COUNTER = Math.max(ColoredPluggingTransition.ID_COUNTER, portId + 1);
		...
		return new ColoredPluggingTransition(portId, sourceState, destinationState, transition, incoming,
				color);
