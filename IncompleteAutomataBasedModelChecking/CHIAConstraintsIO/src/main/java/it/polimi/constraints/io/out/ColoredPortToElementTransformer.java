 ...
 *
 */
public class ColoredPortToElementTransformer extends XMLTrasformer<ColoredPort, Element> {
	 ...
	 */
	public ColoredPortToElementTransformer(Document doc) {
		super(doc);
	}

	public Element transform(ColoredPort port) throws ParserConfigurationException {
