...
public class IntBAFactoryImpl<
		...
		implements
		IntBAFactory<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION, IntersectionBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION>>

{
	 ...
	 */
	@Override
	public IntersectionBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION> create(
