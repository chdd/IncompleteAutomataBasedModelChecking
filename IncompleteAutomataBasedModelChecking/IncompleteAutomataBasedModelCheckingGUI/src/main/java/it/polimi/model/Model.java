...
import it.polimi.iotmp.IntBAReader;
...
public class Model<
	 ...
	 */
	private IntersectionBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION> intersection;
	...
	private IntBAReader<
		...
		IntBAFactory<STATE,TRANSITION, INTERSECTIONSTATE,
			INTERSECTIONTRANSITION,
		IntersectionBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION>>> intBaReader;
	 ...
	 */
	@Override
	public IntersectionBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION> getIntersection(){
	...
	public void changeIntersection(IntersectionBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION> intersection){
	...
	public Transformer<INTERSECTIONSTATE, Point2D> loadIntersection(String intersectionPath) throws IOException,
		...
		this.intBaReader=
				...
				IntersectionBA<STATE,TRANSITION,INTERSECTIONSTATE,INTERSECTIONTRANSITION>, 
				IntBAFactory<STATE,TRANSITION, INTERSECTIONSTATE,
					INTERSECTIONTRANSITION, IntersectionBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION>>>(
