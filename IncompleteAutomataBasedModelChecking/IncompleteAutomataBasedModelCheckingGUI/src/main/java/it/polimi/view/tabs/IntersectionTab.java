...
public class IntersectionTab<
	...
	TRANSITION, 
	INTERSECTIONSTATE, 
	INTERSECTIONTRANSITION, IntersectionBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION>> intersectionPanel;
		...
		this.intersectionLayout=new FRLayout<INTERSECTIONSTATE,INTERSECTIONTRANSITION>(model.getIntersection().getGraph());
		 this.intersectionPanel=new IntersectionAutomatonJPanel
				 ...
				 STATE, 
					...
					IntersectionBA<STATE, TRANSITION, INTERSECTIONSTATE, INTERSECTIONTRANSITION>>(model.getIntersection(), l, this.intersectionLayout);
