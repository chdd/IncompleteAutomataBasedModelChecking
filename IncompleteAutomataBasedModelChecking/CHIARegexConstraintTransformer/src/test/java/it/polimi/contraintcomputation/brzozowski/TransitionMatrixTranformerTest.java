...
public class TransitionMatrixTranformerTest {
	...
	public void testTransform() {
		...
		assertEquals(t1.getPropositions().toString(), matrix[0][1]);
		...
		assertEquals(t2.getPropositions().toString(), matrix[1][2]);
		
		assertEquals(Constants.EMPTYSET, matrix[2][0]);
		assertEquals(Constants.EMPTYSET, matrix[2][1]);
		assertEquals(t3.getPropositions().toString(), matrix[2][2]);
	}
