...
/**
 * <p>
 * The IntersectionBA class is used to represent the intersection
 * automaton. The intersection automaton extends a BA. It contains the
 * set of the mixed states which are obtained by considering a
 * transparent state of the model and a state of the claim and the set of the
 * constrained transitions, i.e., the set of transitions of the intersection
 * automaton which are generated by performing a transition in the claim when
 * the model is in a transparent state.
 * 
